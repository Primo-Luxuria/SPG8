...
class UserProfile(models.Model):
    ...
    user = models.OneToOneField(User, on_delete=models.CASCADE, null=True, blank=True)  # Delete whole profile if user is deleted
...
class Course(models.Model):
    ...
    # linking teachers (users with teacher role) to this course.
