...
class Template(models.Model):
    ...
    # Font and size selections for different sections
    title_font = models.CharField(max_length=100, choices=FONT_CHOICES, default="Arial")
    title_size = models.IntegerField(default=16)
    
    subtitle_font = models.CharField(max_length=100, choices=FONT_CHOICES, default="Arial")
    subtitle_size = models.IntegerField(default=14)
    
    body_font = models.CharField(max_length=100, choices=FONT_CHOICES, default="Arial")
    body_size = models.IntegerField(default=12)
